        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Semua Data Acara</h3>
                <a href="tambah_acara.php" class="btn btn-success pull-right"><i class="fa fa-user-plus"></i> Tambah Acara</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  if($_SESSION['role'] == 'admin'){
                    foreach ($data->showAllAcara() as $ss) {
                ?>
                    <tr>
                        <td><?php echo $no++; ?></td>
                ...
                <?php
                    ...
                    foreach ($data->showAcaraByUser($_SESSION['nama']) as $ss) {
                ?>
                    <tr>
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $ss['acara_nama']?></td>
