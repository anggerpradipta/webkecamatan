    ...
    <div class="row">
      ...
      <div class="col-xs-12 table-responsive" style="font-size:12px;">
        ...
        <table class="table">
                    ...
                    <tr>
                        <th style="padding:5px; width: 180px;">Nama Acara</th>
                    ...
                    <tr>
                        <th style="padding:5px; width: 180px;">Jam</th>
                    ...
                    <tr>
                        <th style="padding:5px; width: 180px; background-color:rgba(233, 237, 243, 0.5);">Menghadiri</th>
                    ...
                    <tr>
                            ...
                            <td style="padding:5px;"> 
                                <img src="../../images/<?php echo $acara['acara_foto'];?>" style="width:200px; height:auto;">
                            </td>
                            <?php
                                }
                            ?>
